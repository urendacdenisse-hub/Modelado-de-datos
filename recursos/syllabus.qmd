...
El material del curso estará disponible en un repositorio de GitHub, donde se publicarán las presentaciones, notebooks, conjuntos de datos y recursos complementarios. Los notebooks estarán desarrollados en Google Colab y servirán como apoyo para reproducir los ejemplos y experimentos presentados durante el curso.

El proyecto semestral deberá documentarse mediante un reporte técnico elaborado en Overleaf, siguiendo una estructura similar a la de un artículo científico. El objetivo del reporte es desarrollar la capacidad de comunicar de manera clara el problema abordado, la metodología empleada, las decisiones tomadas y los resultados obtenidos.
